...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" style={{ fontFamily: 'Madefor, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
      <Header />
      {/* Hero Section */}
      <section className="relative px-4 sm:px-8 lg:px-16 py-16 sm:py-24 lg:py-32 min-h-screen flex items-center overflow-hidden">
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
            
            {/* Floating Stats */}
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 lg:gap-6 mb-8 sm:mb-12">
              {stats.map((stat, index) => {
                const Icon = stat.icon;
                return (
                  <div key={index} className="flex items-center space-x-2 sm:space-x-3 px-3 sm:px-4 lg:px-6 py-2 sm:py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 hover:bg-purple-500/20 hover:border-purple-400/50 transition-all duration-500">
                    <Icon className="w-4 h-4 sm:w-5 sm:h-5 text-purple-300" />
                    <span className="text-white font-bold text-sm sm:text-base lg:text-lg">{stat.number}</span>
                    <span className="text-gray-300 text-xs sm:text-sm lg:text-base hidden sm:inline">{stat.label}</span>
                  </div>
                );
              })}
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-transparent bg-gradient-to-r from-white via-purple-200 to-blue-200 bg-clip-text mb-6 sm:mb-8 leading-tight text-center lg:text-left">
              Revolutionizing
              <br />
              <span className="text-transparent bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text">
                Recruitment
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-200 mb-8 sm:mb-12 leading-relaxed max-w-4xl text-center lg:text-left mx-auto lg:mx-0">
              InterXAI bridges the gap between traditional interview preparation and real-world hiring processes. 
              Our AI-powered platform provides personalized recruitment experiences for both candidates and employers.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
              <div className="bg-gradient-to-r from-purple-900/50 to-blue-900/50 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-purple-500/20">
                <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0">
                    <Target className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                  </div>
                  <h3 className="text-xl sm:text-2xl font-bold text-white">For Candidates</h3>
                </div>
              ...
              <div className="bg-gradient-to-r from-blue-900/50 to-cyan-900/50 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-blue-500/20">
                <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0">
            ...
            <div className="text-center">
              <button className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 sm:px-8 lg:px-12 py-4 sm:py-5 lg:py-6 rounded-full text-base sm:text-lg lg:text-2xl font-bold hover:from-purple-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-purple-500/30 flex items-center space-x-2 sm:space-x-3 mx-auto">
                <span>Explore Our Platform</span>
      ...
      {/* Features Section */}
      <section className="px-4 sm:px-8 lg:px-16 py-16 sm:py-24 lg:py-32 bg-gradient-to-br from-slate-800/50 to-purple-900/30 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          
          {/* Section Header */}
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-transparent bg-gradient-to-r from-white to-gray-300 bg-clip-text mb-4 sm:mb-6 lg:mb-8">
              Revolutionary Features
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16 lg:mb-20">
            {features.map((feature, index) => {
              ...
              return (
                <div 
                  key={index}
                  className={`group relative bg-gradient-to-br from-slate-900/50 to-purple-900/30 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 border transition-all duration-700 hover:transform hover:scale-105 cursor-pointer ${
                    isActive 
                      ? 'border-purple-400/70 shadow-2xl shadow-purple-500/30 scale-105' 
                      : 'border-purple-500/20 hover:border-purple-400/50'
                  }`}
                ...
                >
                  <div className="flex justify-center mb-4 sm:mb-6">
                    <div className={`w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-r ${feature.color} rounded-xl sm:rounded-2xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-500 ${isActive ? 'rotate-12 scale-110' : ''}`}>
                      <Icon className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-white" />
                    </div>
                  </div>
                  
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-3 sm:mb-4 text-center group-hover:text-purple-200 transition-colors">
                    {feature.title}
                  </h3>
                  
                  <p className="text-sm sm:text-base text-gray-300 text-center leading-relaxed group-hover:text-gray-200 transition-colors">
                    {feature.description}
                  </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 mb-12 sm:mb-16 lg:mb-20">
            ...
            {/* AI-Powered Coding Tests */}
            <div className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 border border-purple-500/20">
              <div className="flex items-center space-x-3 sm:space-x-4 mb-6 sm:mb-8">
                <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-r from-purple-500 to-blue-500 rounded-xl sm:rounded-2xl flex items-center justify-center shrink-0">
                  <Code className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-white" />
                </div>
                <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">AI-Powered Coding Tests</h3>
              </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-center space-x-3">
                    <item.icon className="w-4 h-4 sm:w-5 sm:h-5 text-purple-300 shrink-0" />
            ...
            {/* Leaderboard System */}
            <div className="bg-gradient-to-br from-blue-900/30 to-cyan-900/30 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 border border-blue-500/20">
              <div className="flex items-center space-x-3 sm:space-x-4 mb-6 sm:mb-8">
                <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-xl sm:rounded-2xl flex items-center justify-center shrink-0">
                  <Trophy className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-white" />
                </div>
                <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">Competitive Leaderboard</h3>
              </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-center space-x-3">
                    <item.icon className="w-4 h-4 sm:w-5 sm:h-5 text-blue-300 shrink-0" />
                    <span className="text-sm sm:text-base text-gray-300">{item.text}</span>
                  </div>
                ))}
              </div>
          ...
          {/* Technology Stack */}
          <div className="bg-gradient-to-r from-slate-900/50 to-purple-900/50 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-purple-500/20 mb-12 sm:mb-16 lg:mb-20">
            <div className="text-center mb-8 sm:mb-10 lg:mb-12">
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4">Powered by Advanced AI</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
              <div className="text-center">
                <div className="w-16 h-16 sm:w-18 sm:h-18 lg:w-20 lg:h-20 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl sm:rounded-3xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <Brain className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 text-white" />
                </div>
                <h4 className="text-lg sm:text-xl font-bold text-white mb-2">Grok AI Integration</h4>
                <p className="text-sm sm:text-base text-gray-300 px-2">Advanced language model for intelligent evaluation and feedback</p>
              </div>

              <div className="text-center">
                <div className="w-16 h-16 sm:w-18 sm:h-18 lg:w-20 lg:h-20 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl sm:rounded-3xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <Activity className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 text-white" />
                </div>
                <h4 className="text-lg sm:text-xl font-bold text-white mb-2">Real-Time Analysis</h4>
                <p className="text-sm sm:text-base text-gray-300 px-2">Live speech and behavioral pattern recognition technology</p>
              </div>

              <div className="text-center sm:col-span-2 md:col-span-1">
                <div className="w-16 h-16 sm:w-18 sm:h-18 lg:w-20 lg:h-20 bg-gradient-to-r from-green-500 to-blue-500 rounded-2xl sm:rounded-3xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <PieChart className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 text-white" />
                </div>
                <h4 className="text-lg sm:text-xl font-bold text-white mb-2">Predictive Analytics</h4>
                <p className="text-sm sm:text-base text-gray-300 px-2">Machine learning algorithms for performance prediction</p>
              </div>
            </div>
          </div>
          ...
          {/* Call to Action */}
          <div className="text-center">
            <div className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-purple-500/20">
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4 sm:mb-6">Ready to Transform Your Career?</h3>
              <p className="text-base sm:text-lg lg:text-xl text-gray-300 mb-6 sm:mb-8 max-w-3xl mx-auto px-4">
                Join thousands of professionals who have already elevated their interview skills and landed their dream jobs with InterXAI.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
                <button className="w-full sm:w-auto bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 text-white px-8 sm:px-10 lg:px-12 py-4 sm:py-5 lg:py-6 rounded-full text-lg sm:text-xl lg:text-2xl font-bold hover:from-purple-700 hover:via-blue-700 hover:to-cyan-700 transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-purple-500/30">
                  Start Your Journey
                </button>
                ...
                <div className="flex items-center space-x-2 text-gray-300">
                  ...
                  <span className="text-sm sm:text-base lg:text-lg">Trusted by 50,000+ users</span>
                </div>
              </div>
            </div>
          </div>
